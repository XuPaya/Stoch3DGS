...
class Renderer:
    ...
    def from_checkpoint(
        ...
        # Overrides: always use variance-free renderer.
        # Comment out the following line to use the stochastic renderer for testing.
        conf["render"]["pipeline_type"] = "reference"
